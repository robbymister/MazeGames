...
class Player:
    def __init__(self, name, UserType, x, y):
        self.name = name
    ...
    def get_direction(self):
        ...
        if direction not in "NWES":
            print("Invalid move.")
        while direction in "NWES":
            return direction
    ...
    def player_type(self):
        if self.UserType == "u":
            Human = UserPlayer(player_name, x, y)
        elif self.UserType == "c":
            Computer = ComputerPlayer(player_name, x, y)
